					...
					success : function(data) {
						...
						$
								.each(
										data,
										function(key, value) {
											a += '<div class="commentArea" style="border:1px solid darkgrey;padding:1%; margin-bottom: 15px; font-size:15px">';
											...
											a += '<div class="commentContent'+value.id+'" style="font-size:20px"> <p> 내용 : '
													+ value.content + '</p>';
											a += '</div></div>';
										});
						$(".commentList").html(a);
