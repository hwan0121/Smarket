...
<body>
	...
	<div class="container">
		...
		<div class="maindv">
			<img src="/images/main.PNG" class="mimg"> 
				<a
				href="/shop/search?word=${scnt[0].name}"><span class="sunwi"
				style="top: 55%; margin-left:50px">1. ${scnt[0].name}  (${scnt[0].cnt})</span> </a>
				<a href="/shop/search?word=${scnt[1].name}"><span class="sunwi"
				style="top: 60%;margin-left:50px">2. ${scnt[1].name}  (${scnt[1].cnt})</span></a> <a
				href="/shop/search?word=${scnt[2].name}"><span class="sunwi"
				style="top: 65%;margin-left:50px">3. ${scnt[2].name}  (${scnt[2].cnt})</span></a> <a
				href="/shop/search?word=${scnt[3].name}"><span class="sunwi"
				style="top: 70%;margin-left:50px">4. ${scnt[3].name}  (${scnt[3].cnt})</span></a> <a
				href="/shop/search?word=${scnt[4].name}"><span class="sunwi"
				style="top: 75%;margin-left:50px">5. ${scnt[4].name}  (${scnt[4].cnt})</span></a> <a
				href="/shop/search?word=${scnt[5].name}"><span class="sunwi"
				style="top: 80%;margin-left:50px">6. ${scnt[5].name}  (${scnt[5].cnt})</span></a> <a
				href="/shop/search?word=${scnt[6].name}"><span class="sunwi"
				style="top: 85%;margin-left:50px">7. ${scnt[6].name}  (${scnt[6].cnt})</span></a>
