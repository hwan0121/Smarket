...
<body>
    <div class="container">
                ...
                <ul class="navbar-nav mr-auto">
                    ...
                    <sec:authorize access="authenticated">
                        ...
                        <li class="nav-item" style="margin-top: 13px;"><a
                            ...
                            <li class="nav-item" style="margin-top: 13px;"><a
                                href="/shop/searchUser" class="nav-item"
                                style="font-family: 'Poor Story', cursive; color: black; font-size: 13px; margin: 3px; color: black;">회원검색</a></li>
                        <li class="nav-item" style="margin-top: 13px;"><a
        ...
        <div>
            <ul>
                <a href="${R}shop/hotproduct"
                    style="color: red; font-size: 1.5em; margin-right: 8px;">인기상품</a></li>
                <c:forEach var="c" items="${category}">
                    <a href="${R}shop/category/${c.id}"
                        style="color: black; font-size: 1.5em; margin-right: 8px;">${c.name}</a></li>
                </c:forEach>
            </ul>
        </div>
    </div>
